      ...
      <div className="container">
        ...
        <div className="relative">
          <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10  rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
            ...
            <Generating
              className={
                "absolute left-4 right-4 bottom-4 border-n-1/10 lg:left-1/2 lg:right-auto lg:bottom-8 lg:-translate-x-1/2"
              }
            />
          </div>
          <div className="z-1 grid lg:grid-cols-2 gap-5">
            ...
            <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem] ">
              <div className="py-12 px-4 xl:px-8">
                ...
                <p className="body-2 mb-[2rem] text-n-3">
                  The World&apos;s most powerfull AI photo and Video art
                  ...
                  {brainwaveServicesIcons.map((item, index) => (
                    <li
                      className={`flex rounded-2xl items-center justify-center ${
                        index === 2
                          ? "w-[3rem] h-[3rem] p-0.5 bg-conic-gradient rounded-t-2xl md:w-[4.5rem] md:h-[4.5rem]"
